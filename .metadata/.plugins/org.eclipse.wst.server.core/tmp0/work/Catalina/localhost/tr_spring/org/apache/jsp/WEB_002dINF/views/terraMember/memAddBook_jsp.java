 ...
 * Generated at: 2023-07-31 05:29:55 UTC
...
public final class memAddBook_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	ArrayList<TerraMemberVO> aList = (ArrayList<TerraMemberVO>)obj;
      ...
      out.write("				var nameVal = $(this).find('td').eq(0).text();\r\n");
      out.write("				var mailVal = $(this).find('td').eq(1).text();\r\n");
      out.write("				var hpVal = $(this).find('td').eq(2).text();\r\n");
      out.write("				var positionVal = $(this).find('td').eq(3).text();\r\n");
      out.write("				var deptVal = $(this).find('td').eq(4).text();\r\n");
      out.write("				var photoVal = $(this).find('input').eq(0).val();\r\n");
      out.write("				\r\n");
      out.write("				$('#emname').text(nameVal);\r\n");
      out.write("				$('#email').text(mailVal);\r\n");
      out.write("				$('#hp').text(hpVal);\r\n");
      out.write("				$('#position').text(positionVal);\r\n");
      out.write("				$('#dept').text(deptVal);\r\n");
      out.write("				\r\n");
      out.write("				var photoPath = \"fileupload/tmem/\" + photoVal;\r\n");
      out.write("				$('#photo').attr('src', photoPath);\r\n");
      out.write("				\r\n");
      out.write("				console.log(photoVal + \":\" + mailVal + \":\" + hpVal + \":\" + positionVal + \":\" +deptVal);\r\n");
      out.write("				\r\n");
      out.write("			});\r\n");
      out.write("			\r\n");
      out.write("			$.ajax({\r\n");
      ...
      out.write("				<a class=\"nav-link dropdown-toggle\" id=\"dropdown01\" data-bs-toggle=\"dropdown\" aria-expanded=\"false\" style=\"padding-top:13px;font-size:18px;color:#534825;font-weight:bold;cursor:pointer\">주소록</a>\r\n");
      ...
      out.write("				<button type=\"button\" class=\"btn btn-primary\" id=\"istBtn\" style=\"background-color:#E2F0D9;height:50px;border:0; font-size:20px;font-weight:1000;color:#E2F0D9;\" disabled ></button>\r\n");
      out.write("				<br>\r\n");
      ...
      out.write("						  <li><div id=\"nowSelected\" class=\"idx\" onclick=\"javascript:location.href='/tr_spring/tMemAddrBook.tr'\"><img src=\"/tr_spring/resources/images/address-book.png\" class=\"icon_img\"><span class=\"link-dark rounded\" style=\"font-size:20px;margin-left:12px\">전체</span></div></li>\r\n");
      out.write("						  <li><div class=\"idx\" onclick=\"javascript:location.href='/tr_spring/tMemAddrBook.tr'\"><img src=\"/tr_spring/resources/images/star.png\" class=\"icon_img\"><span class=\"link-dark rounded\" style=\"font-size:20px;margin-left:12px\">즐겨찾기</span></div></li>\r\n");
      out.write("						</ul>\r\n");
      out.write("					  </div>\r\n");
      out.write("					</li>\r\n");
      out.write("				  </ul>\r\n");
      ...
      out.write("			  <div>\r\n");
      out.write("				\r\n");
      out.write("<form name=\"memFormAll\" id=\"memFormAll\" style=\"padding-left:100px\">\r\n");
      out.write("	<br>\r\n");
      out.write("	<table class=\"table table-hover\">\r\n");
      out.write("	<thead>\r\n");
      out.write("<tr>\r\n");
      out.write("	<td colspan=\"10\" align=\"center\" style=\"border:0;text-align:left\">\r\n");
      out.write("		<img src=><h6>주소록 > 전체</h6>\r\n");
      out.write("	</td>\r\n");
      out.write("</tr>\r\n");
      out.write("<tr>\r\n");
      out.write("	<th>이름</th>\r\n");
	...
	for(int i=0; i< aList.size(); i++){
      ...
      out.write(" <input type=\"hidden\" name=\"mphoto\" id=\"mphoto\" value=\"");
      out.print(tmvo.getMphoto());
      out.write("\"></td>\r\n");
      out.write("	<td style=\"width:300px\">");
      out.print( tmvo.getMemail() );
      out.write(" </td>\r\n");
      out.write("	<td style=\"width:250px\">");
      out.print( CodeUtil.hpval(tmvo.getMhp()) );
      out.write("</td>\r\n");
      out.write("	<td style=\"width:100px\">");
      out.print( CodeUtil.mpositionVal(tmvo.getMposition()));
      out.write("</td>\r\n");
      out.write("	<td style=\"width:100px\">");
      out.print( CodeUtil.dappVal(tmvo.getMdeptno()));
      out.write("</td>\r\n");
      out.write("</tr>	\r\n");
      ...
      out.write("</div>\r\n");
      out.write("	");
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "memAddCard.jsp", out, false);
      out.write("\r\n");
