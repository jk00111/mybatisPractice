...
<html>
	...
	<form name="draftForm" id="draftForm">	
		<p id="dBtn" style="color:green">기안하기</p>
		<table border="1" class="type" id="type">
		<colgroup>
		...
		<tr>
			...
			<td><input type="hidden" id="anum" name="anum" readonly>&nbsp;기안서</td>
			<th width="130px;" height="40px;" class="texttp">작성자</th>
			<td><input type="hidden"  id="mnum" name="mnum" readonly>&nbsp;<%=mvo.getMname()%></td>
		</tr>
		<tr>
	...
	<br>
	<jsp:include page="modal.jsp"></jsp:include><br>
...
<%-- 		<jsp:include page="modal.jsp"></jsp:include> --%>
		...
		<table>
			<tr>
				<th width="130px" class="texttp" style="border:solid 1px">제목</th>
				<td><input type="text" name="dsubject" id="dsubject" size="112px" style="border:none;border-right:0px; border-top:0px; boder-left:0px; boder-bottom:0px;outline: none;"></td>
			</tr>
		</table>
		<br>
    ...
    <input type="hidden" id="dmemo" name="dmemo">
    <script>
	...
	<table>
		<tr>
			<th width="130px" class="texttp" style="border:solid 1px">첨부 파일</th>
			<td>
  				<label for="file-upload"></label>
 			    <input type="file" id="dfile" name="dfile" multiple="multiple">
	</table>
		<br>
		<input type="hidden" name="aref" id="aref" value="-,-,-,-,-,">
		<input type="hidden" name="aapp" id="aapp" value="-,-,-,-,-,">
		<input type="hidden" name="atype" id="atype" value="D">
		<input type="hidden" name="alevel" id="alevel" value="01">
	</form>
	</div>
	</div>
